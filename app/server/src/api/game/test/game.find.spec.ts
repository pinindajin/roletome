...
import { gameServiceProvider } from '../services/game.service';
import { getRepositoryToken } from '@nestjs/typeorm';
import { Repository } from 'typeorm';
import { DbGame } from '../../../db/typeOrm/dbModels/game/game.entity';
import { ECommonFunctionInjectables } from '../../../common/functions/function-providers';
import { v4 as uuid } from 'uuid';
import { gameStoreProvider, GameStore } from '../stores/game.store';
...
describe('GameFeature', () => {
  let gameController: ICRUDController;
  ...
  beforeAll(async () => {
    ...
    const app = await Test.createTestingModule({
      ...
      providers: [gameServiceProvider, gameStoreProvider, mockGameRepoProvider, mockUUIDProvider],
    }).compile();
  ...
  describe('find', () => {
    ...
    each(testCases).it(
      ...
      async (
        ...
        /**
         * TODO: Finish this higher scoped test thing whatever
         */
